...
export async function indexesCreateCommand(
  ...
  console.log(brand.accent(`✓ Created index "${created.name}" (${created.id}).`));
}
...
export async function indexesDeleteCommand(
  ...
  console.log(brand.accent(`✓ Deleted index "${opts.name}".`));
}
...
export async function indexesAddCommand(
  ...
  console.log(brand.accent(`✓ Added document to "${opts.name}".`));
}
